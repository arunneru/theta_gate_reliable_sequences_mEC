...
#include "neuron/N_InterNeuron_Wang96_clockwise_otherwise_phaseblocking_hetero.hpp"
...
int main(int argc, char **argv) {
	...
	engine::generate_neuron<N_InterNeuron_Wang96>(80);
	engine::generate_synapse<S_TanHSynapse>(7200);
